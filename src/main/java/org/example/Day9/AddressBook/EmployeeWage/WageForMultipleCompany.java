...
public class WageForMultipleCompany {
    ...
    public WageForMultipleCompany(String companyName, int maxHrs, int maxDays, int wagePerHr) {
    ...
    public static void main(String[] args) {
        ...
        WageForMultipleCompany wageForMultipleCompany=new WageForMultipleCompany(str,maxHrs,maxDays,wagePerDay);
        wageForMultipleCompany.checkWage();
    }
}
