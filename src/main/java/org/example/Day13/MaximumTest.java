...
import static org.example.Day13.MaxTest.printMax;
...
//        UC2
        Float rt1 = testMaximum(3.5f, 2.2f, 1.1f);
        Float rt2 = testMaximum(1.1f, 5.5f, 2.2f);
        Float rt3 = testMaximum(1.1f, 2.2f, 9.9f);
        ...
        //Test the refactor
        MaxTest<Integer> obj = new MaxTest<>(10, 20, 30);
        System.out.println("Max: " + obj.testMaximum());
